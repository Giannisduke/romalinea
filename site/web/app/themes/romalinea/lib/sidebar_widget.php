<?php // Adds widget: Sidebar Filters
class Sidebarfilters_Widget extends WP_Widget {
	...
	private $widget_fields = array(
		array(
			'label' => 'sidebar_filters',
			'id' => 'sidebar_filters_id',
			'type' => 'select',
			'options' => array(
				'product_categories',
				'brands',
	...
	public function widget( $args, $instance ) {
		...
		$name = $instance['sidebar_filters_id'];
...
function register_sidebarfilters_widget() {
	register_widget( 'Sidebarfilters_Widget' );
}
add_action( 'widgets_init', 'register_sidebarfilters_widget' );
